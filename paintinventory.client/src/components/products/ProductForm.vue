      ...
      <v-card-text>
        <v-form v-model="valid">
          <v-row dense>
            ...
            <v-col cols="12" sm="6"><v-select v-model="form.component" :items="componentOptions" label="Component" variant="outlined" density="comfortable" /></v-col>
            <v-col cols="6" sm="3"><v-text-field v-model.number="form.packVolume" label="Pack volume" type="number" variant="outlined" density="comfortable" /></v-col>
            <v-col cols="6" sm="3"><v-text-field v-model="form.unit" label="Unit" variant="outlined" density="comfortable" /></v-col>
            <v-col cols="12" sm="6"><v-text-field v-model="form.defaultShade" label="Shade / colour" variant="outlined" density="comfortable" /></v-col>
            <v-col cols="12" sm="6"><v-text-field v-model="form.ralCode" label="RAL code" variant="outlined" density="comfortable" /></v-col>
            <v-col cols="12" sm="6"><v-text-field v-model="form.manufacturer" label="Manufacturer" variant="outlined" density="comfortable" /></v-col>
